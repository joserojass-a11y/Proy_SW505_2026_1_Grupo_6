...
export class Migration1780714089885 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "booking_status_history" DROP CONSTRAINT "FK_booking_status_history_booking"`);
        await queryRunner.query(`ALTER TABLE "booking_status_history" DROP CONSTRAINT "FK_booking_status_history_user"`);
        await queryRunner.query(`ALTER TABLE "booking_cancellations" DROP CONSTRAINT "FK_booking_cancellations_booking"`);
        await queryRunner.query(`ALTER TABLE "booking_cancellations" DROP CONSTRAINT "FK_booking_cancellations_user"`);
        await queryRunner.query(`ALTER TABLE "booking_reschedules" DROP CONSTRAINT "FK_booking_reschedules_booking"`);
        await queryRunner.query(`ALTER TABLE "booking_reschedules" DROP CONSTRAINT "FK_booking_reschedules_user"`);
        await queryRunner.query(`ALTER TABLE "notification_events" DROP CONSTRAINT "FK_notification_events_tenant_id"`);
        await queryRunner.query(`ALTER TABLE "notification_events" DROP CONSTRAINT "FK_notification_events_template_id"`);
        await queryRunner.query(`ALTER TABLE "customer_notification_preferences" DROP CONSTRAINT "FK_customer_notification_preferences_customer"`);
        await queryRunner.query(`ALTER TABLE "customer_notification_preferences" DROP CONSTRAINT "FK_customer_notification_preferences_topic"`);
        await queryRunner.query(`ALTER TABLE "customer_notification_preferences" DROP CONSTRAINT "FK_customer_notification_preferences_channel"`);
        await queryRunner.query(`DROP INDEX "public"."idx_booking_service_starts_ends"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_notification_events_status_scheduled"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_notification_events_tenant_created"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_notification_events_booking_id"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_notification_events_recipient"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_customer_notification_preferences_customer"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_customer_notification_preferences_enabled"`);
        await queryRunner.query(`ALTER TABLE "notification_events" DROP CONSTRAINT "CK_notification_events_status"`);
        await queryRunner.query(`ALTER TABLE "notification_events" DROP CONSTRAINT "CK_notification_events_recipient_type"`);
        await queryRunner.query(`ALTER TABLE "customer_notification_preferences" DROP CONSTRAINT "UQ_customer_notification_preferences"`);
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX "UQ_customer_notification_preferences" ON "customer_notification_preferences" ("customer_id", "topic_id", "channel_id") `);
    }
